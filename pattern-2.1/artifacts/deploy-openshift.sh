...
oc create configmap apim-is-km-conf --from-file=../confs/is-as-km/repository/conf/
oc create configmap apim-is-km-axis2 --from-file=../confs/is-as-km/repository/conf/axis2/
oc create configmap apim-is-km-datasources --from-file=../confs/is-as-km/repository/conf/datasources/
oc create configmap apim-is-km-tomcat --from-file=../confs/is-as-km/repository/conf/tomcat/
