...
wso2am-pattern-3-am-devportal-ingress             <RELEASE_NAME>-devportal              <EXTERNAL-IP>    80, 443    7m
wso2am-pattern-3-am-publisher-ingress             <RELEASE_NAME>-publisher              <EXTERNAL-IP>    80, 443    7m
...
```
  <EXTERNAL-IP> <RELEASE_NAME>-devportal
  <EXTERNAL-IP> <RELEASE_NAME>-publisher
  <EXTERNAL-IP> <RELEASE_NAME>-gateway
  <EXTERNAL-IP> <RELEASE_NAME>-analytics-dashboard
```

c. Try navigating to `https://<RELEASE_NAME>-publisher/carbon`, `https://<RELEASE_NAME>-publisher/publisher` and `https://<RELEASE_NAME>-devportal/devportal`
...
| `wso2.deployment.am.minReadySeconds`                                        | Refer to [doc](https://v1-14.docs.kubernetes.io/docs/reference/generated/kubernetes-api/v1.14/#deploymentspec-v1-apps)| 30        |
