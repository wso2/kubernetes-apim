...
DROP DATABASE IF EXISTS WSO2AM_USER_DB;
DROP DATABASE IF EXISTS WSO2AM_REG_DB;
DROP DATABASE IF EXISTS WSO2AM_ANALYTICS_DB;
DROP DATABASE IF EXISTS WSO2_PERMISSIONS_DB;

CREATE DATABASE WSO2AM_APIMGT_DB;
CREATE DATABASE WSO2AM_USER_DB;
CREATE DATABASE WSO2AM_REG_DB;
CREATE DATABASE WSO2AM_ANALYTICS_DB;
CREATE DATABASE WSO2_PERMISSIONS_DB;

GRANT ALL ON WSO2AM_APIMGT_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2AM_USER_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2AM_REG_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2AM_ANALYTICS_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2_PERMISSIONS_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
