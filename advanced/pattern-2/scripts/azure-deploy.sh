...
${KUBERNETES_CLIENT} create -f ../apim-is-as-km/wso2apim-is-as-km-volume-claim-azure.yaml
...
${KUBERNETES_CLIENT} create -f ../apim-pub-store-tm/wso2apim-pub-store-tm-volume-claim-azure.yaml
...
${KUBERNETES_CLIENT} create -f ../apim-gw/wso2apim-gateway-volume-claim-azure.yaml
