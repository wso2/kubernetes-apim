...
Common labels
*/}}
{{- define "am-pattern-2.labels" -}}
app.kubernetes.io/name: {{ include "am-pattern-2.name" . }}
helm.sh/chart: {{ include "am-pattern-2.chart" . }}
...
*/}}
{{- define "am-pattern-2.resource.prefix" -}}
{{- "wso2am-pattern-2" }}
{{- end -}}
