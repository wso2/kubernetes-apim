...
${KUBERNETES_CLIENT} create -f ../apim-tm/wso2apim-tm-volume-claim-azure.yaml
...
${KUBERNETES_CLIENT} create -f ../apim-gateway/wso2apim-gateway-volume-claim-azure.yaml
