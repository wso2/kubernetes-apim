...
Common labels
*/}}
{{- define "am-pattern-4.labels" -}}
app.kubernetes.io/name: {{ include "am-pattern-4.name" . }}
helm.sh/chart: {{ include "am-pattern-4.chart" . }}
...
*/}}
{{- define "am-pattern-4.resource.prefix" -}}
{{- "wso2am-pattern-4" }}
{{- end -}}
