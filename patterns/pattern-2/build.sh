...
docker build -t wso2/wso2am-gw-rsync-pattern-2:2.1.0 $manager_worker_rsync_dir --squash
docker build -t wso2/wso2am-tm-rsync-pattern-2:2.1.0 $tm_rsync_dir --squash
