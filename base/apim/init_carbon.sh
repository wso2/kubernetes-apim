...
if [ -e ${WSO2_SERVER_HOME}-conf/conf-identity-identity-providers ]
 then cp ${WSO2_SERVER_HOME}-conf/conf-identity-identity-providers/* ${WSO2_SERVER_HOME}/repository/conf/identity/identity-providers/
fi

if [ -e ${WSO2_SERVER_HOME}-conf/conf-identity-service-providers ]
 then cp ${WSO2_SERVER_HOME}-conf/conf-identity-service-providers/* ${WSO2_SERVER_HOME}/repository/conf/identity/service-providers/
fi
