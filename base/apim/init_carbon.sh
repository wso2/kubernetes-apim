...
if [ -e ${carbon_home}-conf/conf-identity-identity-providers ]
 then cp ${carbon_home}-conf/conf-identity-identity-providers/* ${carbon_home}/repository/conf/identity/identity-providers/
fi

if [ -e ${carbon_home}-conf/conf-identity-service-providers ]
 then cp ${carbon_home}-conf/conf-identity-service-providers/* ${carbon_home}/repository/conf/identity/service-providers/
fi
