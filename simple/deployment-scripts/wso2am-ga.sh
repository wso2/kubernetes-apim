  ...
  template:
    ...
    spec:
      containers:
        - name: wso2apim-mysql
          # image: mysql:5.7
          image: 192.168.1.5:5000/mysql:5.7
          livenessProbe:
            exec:
              command:
                - sh
...
data:
  deployment.toml: |
    ...
    websub_event_receiver_http_endpoint = "http://"ip.node.k8s.&.wso2.apim":9021"
    websub_event_receiver_https_endpoint = "https://"ip.node.k8s.&.wso2.apim":8021"
    ...
    spec:
      ...
      containers:
        - name: wso2am-pattern-1-am
          ...
          image: 192.168.1.5:5000/wso2am:4.0.0-rc
          livenessProbe:
            exec:
              command:
                - /bin/sh
