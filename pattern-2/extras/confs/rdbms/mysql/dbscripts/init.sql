...
DROP DATABASE IF EXISTS WSO2_ANALYTICS_EVENT_STORE_DB;
DROP DATABASE IF EXISTS WSO2_ANALYTICS_PROCESSED_DATA_STORE_DB;
...
GRANT ALL ON WSO2_ANALYTICS_EVENT_STORE_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2_ANALYTICS_PROCESSED_DATA_STORE_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
